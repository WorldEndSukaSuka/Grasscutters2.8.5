...
public class HealAbilityManager {
    ...
    public HealAbilityManager (Player player) {
        ...
        healDataAvatarList.add(new HealDataAvatar(10000065, "Shinobu", 0).addHealData("E", "HealHPOnAdded", "HealHPOnAdded_Const", true).addHealData("E", "HealHP_OnHittingOthers", "HealHP_Const_OnHittingOthers", true));
